...
std::queue<std::string> Logger::time_log;
bool Logger::do_log;
        ...
        while (!exit) {
            try {
                ...
                std::cout << "Оберіть що Ви хочете зробити та введіть відповідну цифру\n"
                             ...
                             "9). Переглянути інформацію про всіх практикантів\n"
                             "10). Перевірити статус робітників/практикантів\n"
                             "11). Переглянути зарплатні відомості\n"
                             "12). Звільнити робітника/практиканта\n"
...
void userInstruction() {
    ...
    std::cout << "Дана програма є системою автоматизації відділу кадрів.\n"
                 ...
                 "\nпідрозділу й не вважається повноцінним робітником.\n"
                 "\nОсновний функціонал програми передбачає додавання/змінення/показ/видалення даних про робітників, стажерів "
                 ...
                 "\nнекоректно."
                 "\n\nПримітка: при перегляді зарплатних відомоcтей керівники не входять в поняття 'робітників', "
