...
Legal::Legal() : Department(), court_cases{0}, win_cases{0} {
    setName("Legal");
    Logger::add_log("base constructor", "Legal");
}
...
Legal::Legal(int income, int premium, int court_cases, int win_cases) :
    ...
    setName("Legal");
    Logger::add_log("input constructor", "Legal");
}
...
Legal::Legal(Legal &&legal) noexcept: Department(std::move(legal)), court_cases{legal.court_cases},
    ...
    legal.court_cases = 0;
    legal.win_cases = 0;
    Logger::add_log("move constructor", "Legal");
}

Legal::~Legal() { Logger::add_log("DESTRUCTOR", "Legal"); }
